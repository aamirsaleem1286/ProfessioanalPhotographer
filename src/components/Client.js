...
const ClientPage = () => {
  // Sample client images, you can replace them with actual image URLs
  const clientImages = [
  ...
  // State to track whether animation should be applied
  ...
  // UseEffect to trigger animation on component mount with a delay
  useEffect(() => {
