  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        ...
        >
          <h1 className="sm:text-4xl font-medium title-font mb-2 text-5xl text-[#fc9003]">
            Pricing
          </h1>
        </motion.div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {pricingData.map((pricing, index) => (
            ...
            >
              <div className={`h-full p-6 rounded-lg border-2 bg-slate-950 ${pricing.popular ? 'border-indigo-500' : 'border-gray-300'} flex flex-col relative overflow-hidden`}>
                {pricing.popular && (
